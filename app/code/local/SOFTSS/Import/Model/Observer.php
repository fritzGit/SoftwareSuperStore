...
class SOFTSS_Import_Model_Observer
{
    ...
    protected $_attributeSetIdGames = 12; //Games attribute set for live 12
    protected $_attributeSetIdSoftware = 13; //Software Softdistribution attribute set for live 13
    protected $_gameCategoryId = 4; //Games Category Id for live 4
