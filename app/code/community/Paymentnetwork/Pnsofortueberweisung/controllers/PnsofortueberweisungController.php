...
class Paymentnetwork_Pnsofortueberweisung_PnsofortueberweisungController extends Mage_Core_Controller_Front_Action
{
	...
	public function redirectAction() {
		...
		switch($payment->getMethod()) {
			...
			case 'sofortlastschrift': 
				$order->addStatusHistoryComment(Mage::helper('pnsofortueberweisung')->__('sofortlastschrift payment loaded.'));
			break;
	...
	protected function _checkReturnedData() {
		...
		if($data['transaction'] &&  $response['orderId'] == $orderId){
			...
			$order->addStatusHistoryComment(Mage::helper('pnsofortueberweisung')->__('Payment was successful.',$data['transaction']))->setIsCustomerNotified(true);
