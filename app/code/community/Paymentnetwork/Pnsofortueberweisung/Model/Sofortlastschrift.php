...
class Paymentnetwork_Pnsofortueberweisung_Model_Sofortlastschrift extends Paymentnetwork_Pnsofortueberweisung_Model_Abstract
{
	...
	*/
	 ...
	 * @return Paymentnetwork_Pnsofortueberweisung_Model_Sofortlastschrift
	 */
	public function initialize($paymentAction, $stateObject)
	{
	    $holdingStatus = Mage::getStoreConfig('payment/sofort/sofortlastschrift_order_status_holding');
